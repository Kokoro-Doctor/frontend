...
//       >
//         <Text
//           style={[styles.yesNoText, value === "yes" && styles.yesNoTextActive]}
//         >
//           Yes
//         </Text>
//       </TouchableOpacity>
...
//       >
//         <Text
//           style={[styles.yesNoText, value === "no" && styles.yesNoTextActive]}
//         >
//           No
//         </Text>
//       </TouchableOpacity>
...
//     setForm((prev) => {
//       const next = prev.diagnoses.map((r, i) =>
//         i === idx ? { ...r, [subKey]: v } : r,
//       );
...
//     setForm((prev) => {
//       const next = prev.procedures.map((r, i) =>
//         i === idx ? { ...r, [subKey]: v } : r,
//       );
...
//               Form is true &amp; correct to the best of our knowledge and
//               belief. If we have made any false or untrue statement, suppression
//               or concealment of any material fact, our right to claim under this
...
//                   <Text style={stylesWeb.cardTitle}>
//                     Medi claim agent – Form B (Hospital)
//                   </Text>
//                   <TouchableOpacity
...
//                       Claim Form Part B (hospital section). Fill in the fields
//                       below, then download the PDF.
//                     </Text>
//                   </View>
...
//         >
//           <Text style={{ fontSize: 12, color: "#1E3A8A" }}>
//             Fill in the hospital claim form details below, then download the
//             PDF.
//           </Text>
//         </View>
...
//                 Preview is only available on web. Switch to Edit mode to fill
//                 fields.
//               </Text>
//             </View>
//           )
          ...
          <View style={stylesWeb.mainRow}>
            ...
            <View style={stylesWeb.content}>
              <View style={stylesWeb.card}>
                ...
                {/* ── SCROLLABLE BODY (form + buttons scroll together) ── */}
                <ScrollView
                  style={{ flex: 1 }}
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
        ...
        {/* BUTTONS — inside ScrollView so they scroll with the form */}
        <TouchableOpacity
          style={[
            styles.primaryBtn,
            isDownloading && { opacity: 0.6 },
