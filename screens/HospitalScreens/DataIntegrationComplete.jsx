                ...
                <View style={styles.card}>
                  ...
                  >
                    <Text style={{ color: "#2563EB", fontSize: 13 }}>
                      Integration complete. {patientCount} patients ·{" "}
                      {doctorCount} doctors · {errorCount} format errors
                      detected.
                    </Text>
                  </View>
      ...
      {(Platform.OS !== "web" || width < 1000) && (
        <SafeAreaView style={stylesMobile.container}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {/* <View style={stylesMobile.integrationBox}>
          <Text style={stylesMobile.integrationText}>
            Integration ID: KK–INT–20240820–HOS001
          </Text>
        </View> */}
            ...
            <View style={{ marginTop: 20 }}>
              ...
              <TouchableOpacity
                style={stylesMobile.secondaryButton}
                onPress={() => {
                  navigation.navigate("DataIntegration");
                }}
              >
              ...
              <TouchableOpacity style={stylesMobile.primaryButton}>
                <Text style={stylesMobile.primaryButtonText}>
                  View Imported patients now
                </Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
