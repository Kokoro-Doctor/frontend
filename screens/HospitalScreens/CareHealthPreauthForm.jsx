...
export default function CareHealthPreAuth({ navigation, route }) {
  ...
  const htmlPreview = useMemo(
    () => generateInsuranceFormHTML(form, signatureImage, logoDataUrl),
    [form, signatureImage, logoDataUrl],
  );
  ...
  useEffect(() => {
    ...
    getLogoBase64()
      .then((uri) => {
        if (isMounted) setLogoDataUrl(uri);
      })
      .catch(() => {
                          ...
                          <View ref={formRef}>
                            <View style={stylesWeb.formHeaderContainer}>
                              <View style={{ alignItems: "center" }}>
                                <Image
                                  source={require("../../assets/HospitalPortal/Images/preauth_Carehealth.png")}
                                  style={{
                                    width: 220,
                                    height: 60,
                                    resizeMode: "contain",
                              ...
                              <View style={stylesWeb.headerRowBottom}>
                                <View style={{ flex: 1 }}>
                                  ...
                                  <Text style={stylesWeb.centerSub}>
                                    ...
                                    provide further details on a separate sheet.
                                  </Text>
                                </View>
