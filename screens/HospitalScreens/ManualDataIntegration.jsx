...
//                             Adding many patients? Upload via Excel for faster
//                             entry
//                           </Text>

//                           <View style={styles.excelLabel}>
//                             <View style={styles.excelLabelBadge}>
//                               <Text style={styles.excelLabelBadgeText}>1</Text>
//                             </View>
//                             <Text style={styles.excelLabelText}>
//                               Import from excel/csv
//                             </Text>
//                           </View>

//                           {/* Dropzone */}
//                           <View style={styles.excelDropzone}>
...
//                               }}
//                             >
//                               <Text style={styles.excelClickHere}>
//                                 Click here
//                               </Text>
//                             </TouchableOpacity>

//                             {uploadFile && (
//                               <Text style={styles.excelFileName}>
//                                 📄 {uploadFile.name}
//                               </Text>
//                             )}
//                           </View>
...
//                             <View style={styles.excelSuccessBanner}>
//                               <Text style={styles.excelSuccessText}>
//                                 ✓ File received! Data will be live within{" "}
//                                 {uploadResult.eta_hours ?? 24} hours.
//                               </Text>
//                               <Text style={styles.excelStagingId}>
//                                 Staging ID: {uploadResult.staging_id}
//                               </Text>
//                             </View>
//                           )}
//                           {uploadStatus === "error" && (
//                             <View style={styles.excelErrorBanner}>
//                               <Text style={styles.excelErrorText}>
//                                 ⚠️ {uploadError}
//                               </Text>
//                             </View>
//                           )}
...
//                                     size="small"
//                                   />
//                                   <Text style={styles.excelUploadBtnText}>
//                                     Uploading...
//                                   </Text>
//                                 </View>
//                               ) : (
...
//                     <Text style={styles.mobileTemplateBtnText}>
//                       Download Template
//                     </Text>
//                   </TouchableOpacity>
//                   <Text style={styles.excelTemplateHint}>
...
const ManualDataIntegration = ({ navigation }) => {
  ...
  //           } else {
  //             // XLSX — count rows using regex on raw binary (no library needed)
  //             const text = await file.text();
  //             // Each data row in xlsx XML has <row ...> tag
  //             const matches = text.match(/<row /g);
  //             const count = matches ? Math.max(0, matches.length - 1) : null; // minus header row
  //             setUploadResult((prev) => ({ ...prev, total_patients: count }));
  //           }
  //         } catch (_) {
