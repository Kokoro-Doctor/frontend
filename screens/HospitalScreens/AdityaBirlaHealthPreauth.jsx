...
} from "../../utils/AdityaBirlaHealthPreauth";
//import { mapToFormB } from "../../utils/CareHealthMapper";
import { mapToAdityaBirlaPreauth } from "../../utils/AdityaBirlaHealthPreAuthMapper";
...
export default function StarHealthPreAuth({ navigation, route }) {
  ...
  const formSeed = useMemo(() => {
    const data = mapToAdityaBirlaPreauth(analysisData);
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.infoBox}>
        <Text style={styles.infoText}>
          Aditya Birla Health pre-auth form generated. Review below, make any
