/**
 * CareHealthFormAContent — pure form component.
...
// ─── Main Component ────────────────────────────────────────────────────────────
export default function CareHealthFormAContent({
  form,
  setField,
  signatureImage,
  setSignatureImage,
      ...
      <View>
        ...
        <View style={styles.formHeaderContainer}>
          <View style={styles.formHeaderBanner}>
            <Image
              source={require("../../assets/HospitalPortal/Images/Care-Health-logo.webp")}
              style={styles.careHeaderLogo}
              resizeMode="contain"
            />
          </View>
          <View style={styles.formHeaderBottomStrip} />
        </View>
              ...
              <View style={styles.rowBetween}>
                <View style={styles.inlineRow}>
                  ...
                  <ToggleCheckbox
                    ...
                    onPress={() =>
                      setField("reportedPolice", !form.reportedPolice)
                    }
                  />
                </View>
                <View style={styles.inlineRow}>
              ...
              <View style={styles.inlineRow}>
                ...
                <ToggleCheckbox
                  ...
                  onPress={() =>
                    setField(
                      "domiciliary",
                      yesSelected(form.domiciliary) ? "" : "yes",
                    )
                  }
                />
                <Text style={styles.smallText}>Yes</Text>
                <ToggleCheckbox
                  ...
                  onPress={() =>
                    setField(
                      "domiciliary",
                      noSelected(form.domiciliary) ? "" : "no",
                    )
                  }
                />
                <Text style={styles.smallText}>No</Text>
              ...
              {Array.from({ length: 10 }).map((_, rowIndex) => (
                <View key={rowIndex} style={styles.tableRow}>
                  ...
                  <View style={[styles.tableCellInputWrap, { flex: 1 }]}>
                    <TextInput
                      style={styles.tableInput}
                      value={form.billsRows?.[rowIndex]?.towards ?? ""}
                      onChangeText={(t) => {
                        const next = [...(form.billsRows ?? [])];
                        next[rowIndex] = {
                          ...(next[rowIndex] ?? {}),
...
const styles = StyleSheet.create({
  formHeaderContainer: { paddingTop: 10, paddingBottom: 8 },
  formHeaderBanner: {
    minHeight: 74,
    backgroundColor: "#F7EDB8",
    borderTopWidth: 1,
    borderTopColor: "#E5D57A",
    paddingHorizontal: 16,
    paddingVertical: 12,
    justifyContent: "center",
  },
  careHeaderLogo: { width: 245, height: 52 },
  formHeaderBottomStrip: { height: 12, backgroundColor: "#fff" },
