...
export default function PreAuthStarHealthForm({ navigation, route }) {
  const analysisData = route?.params?.analysisData;
  const { width } = useWindowDimensions();

  // determine if the component is rendered in an embedded context (passed via route params)
  const embedded = route?.params?.embedded ?? false;
    ...
    return (
      <>
        ...
        <View style={stylesWeb.cardTitleRow}>
          <Text style={stylesWeb.cardTitle}>Star Health claim agent</Text>
        </View>
              ...
              <View style={stylesWeb.stepItem}>
                ...
                <View style={{ marginLeft: 8 }}>
                  <Text
                    style={[
                      stylesWeb.stepLabel,
                      (step.done || step.active) && stylesWeb.stepLabelActive,
                    ]}
                  >
                    {step.label}
                  </Text>
        ...
        <View style={{ backgroundColor: "#E8F0FE" }}>
          <Text>Updated claim file generated...</Text>
        </View>

        {/* CLAIM CARD - preview/edit */}
            ...
            <ScrollView>
              <View ref={formRef}>
                ...
                <View style={stylesWeb.sectionContainer}>
                  ...
                  <View style={stylesWeb.sectionContentRow}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={stylesWeb.rowBetween}>
                        <View style={stylesWeb.inlineRow}>
                          <Text style={stylesWeb.label}>Sum insured (Rs.)</Text>
                          <CharBoxRow
                            length={12}
                            value={form.insuranceSumInsured}
                            onChange={(v) => setField("insuranceSumInsured", v)}
                            keyboardType="numeric"
                          />
                        </View>
                        ...
                        <View style={stylesWeb.inlineRow}>
                          <Text style={stylesWeb.label}>
                            d) Have you been hospitalized in the last four years
                  ...
                  <View style={stylesWeb.sectionContentRow}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={stylesWeb.rowBetween}>
                        ...
                        <View style={stylesWeb.inlineRow}>
                          <Text style={stylesWeb.label}>d) Date of Birth</Text>
                          <CharBoxRow
                            length={8}
                            value={form.dob}
                          ...
                          <React.Fragment key={i}>
                            ...
                            <View
                              style={[
                                stylesWeb.checkbox,
                                relationshipMatches(
                                  form.relationship || form.relationshipSpecify,
                                  item.toLowerCase(),
                                ) && CHECKED_BOX_STYLE,
                              ]}
                            />
                      ...
                      <View style={stylesWeb.inlineRow}>
                          ...
                          <React.Fragment key={i}>
                            ...
                            <View
                              style={[
                                stylesWeb.checkbox,
                                occupationMatches(
                                  form.occupation || form.occupationSpecify,
                                  item.toLowerCase(),
                                ) && CHECKED_BOX_STYLE,
                              ]}
                            />
                        ...
                        <TextInput
                          ...
                          onChangeText={(t) => setField("occupationSpecify", t)}
                        />
                      </View>
                      ...
                      <View style={stylesWeb.rowBetween}>
                        <View style={stylesWeb.inlineRow}>
                          ...
                          <View
                            style={[
                              stylesWeb.checkbox,
                              form.reportedPolice && CHECKED_BOX_STYLE,
                            ]}
                          />
                        </View>
                ...
                <View style={stylesWeb.sectionContainer}>
                  ...
                  <View style={stylesWeb.dividerRow}>
                    <View style={stylesWeb.line} />
                    <Text style={stylesWeb.dividerText}>DETAILS OF CLAIM:</Text>
                    <View style={stylesWeb.line} />
                  </View>
                  ...
                  <View style={stylesWeb.sectionContentRow}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={stylesWeb.rowBetween}>
                        ...
                        <Text style={stylesWeb.label}>vi. Others (code):</Text>
                        <CharBoxRow
                          length={3}
                      ...
                      <View style={stylesWeb.inlineRow}>
                        ...
                        <View
                          style={[
                            stylesWeb.checkbox,
                            isYesValue(form.domiciliary) && CHECKED_BOX_STYLE,
                          ]}
                        />
                        <Text style={stylesWeb.smallText}>Yes</Text>
                        <View
                          style={[
                            stylesWeb.checkbox,
                            isNoValue(form.domiciliary) && CHECKED_BOX_STYLE,
                          ]}
                        />
                        <Text style={stylesWeb.smallText}>No</Text>
                        <Text style={stylesWeb.smallText}>
                      ...
                      <View style={stylesWeb.rowBetween}>
                        ...
                        <CharBoxRow
                          ...
                          onChange={(v) => setField("claimCriticalIllness", v)}
                          keyboardType="numeric"
                        />
                      ...
                      {[
                        ...
                        <View key={i} style={stylesWeb.inlineRow}>
                          <View
                            style={[
                              stylesWeb.checkbox,
                              form.docChecklist?.[i] && CHECKED_BOX_STYLE,
                            ]}
                          />
                          <Text style={stylesWeb.smallText}>{item}</Text>
                        </View>
                  ...
                  <View style={stylesWeb.sectionContentRow}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={stylesWeb.declarationText}>
                        ...
                        claim form is true & correct to the best of my knowledge
                        and belief. If I have made any false or untrue
                        statement, suppression or concealment of any material
                        fact with respect to questions asked in relation to this
                        claim, my right to claim reimbursement shall be
                        forfeited. I also consent & authorize TPA / insurance
                        Company, to seek necessary medical information /
                        documents from any hospital / Medical Practitioner who
                        has attended on the person against whom this claim is
                        made. I hereby declare that I have included all the
                        bills / receipts for the purpose of this claim & that I
